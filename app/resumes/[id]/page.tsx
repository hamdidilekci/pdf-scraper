			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
				...
				<div className="space-y-4">
					...
					<div className="rounded border bg-white p-6">
						{item?.resumeData ? (
							<JsonViewer data={item.resumeData as any} />
						) : (
							<div className="text-center py-8">
								...
								<p className="text-gray-500 mb-2">No extracted data found</p>
								<p className="text-sm text-gray-400">{item.status === 'PENDING' ? 'Data extraction in progress...' : 'Extraction may have failed'}</p>
							</div>
						)}
					</div>
				</div>
